...
function processFile(data, fileName) {
  try {
    ...
    progress.textContent =
      "Добавлено " +
      dntReader.columnNames.length +
      " столб" +
      getNumberPronounce(dntReader.columnNames.length, "ец", "ца", "цов") +
      " из файла " +
      fileName
  } catch (ex) {
    console.log(ex)
    progress.textContent = "Произошла ошибка во время загрузки"
  }
}
